...
<div class="flex h-screen">
    ...
    <div class="hidden lg:flex lg:w-3/5 relative overflow-hidden">
        ...
        <div class="relative z-20 flex flex-col justify-end p-12 pb-16 text-white">
            <p class="text-sm font-light tracking-[0.25em] uppercase text-white/70 mb-4">Join the Legacy</p>
    ...
    <div class="w-full lg:w-2/5 flex flex-col items-center justify-center px-8 md:px-14 bg-white overflow-y-auto py-10">
        <div class="w-full max-w-sm">
            ...
            <h2 class="font-serif text-4xl font-bold text-gray-900 mb-1">Create Account</h2>
            <p class="text-gray-500 text-sm mb-8">Begin your journey through the archives.</p>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                ...
                <a href="{{ route('login') }}" class="text-rust font-semibold hover:text-rust-dark">Sign In</a>
            </p>
